...
[assembly: ExtensionApplication(typeof(CadIME.Host.Net8.AutoCADAdapter))]

namespace CadIME.Host.Net8
{
    /// <summary>
    ...
    public class AutoCADAdapter : IExtensionApplication
    {
        ...
        public void Initialize()
        {
            AppDomain.CurrentDomain.UnhandledException += (s, e) => {
                ...
                File.WriteAllText(Path.Combine(systemTemp, "CadIME_Crash_2025.txt"), e.ExceptionObject.ToString());
            };
            ...
            try
            {
                ...
                if (docManager.MdiActiveDocument != null)
                {
                    docManager.MdiActiveDocument.Editor.WriteMessage("\n>>> [CadIME Modern 2025/2026] 全网深度消杀重组！总线安全焊接网已满血就位！\n");
                }
            }
